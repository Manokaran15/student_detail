                                ...
                                <form class="ps-3 pe-3 form" method="post" action="/register" name="myForm" id="register_form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6 pb-4">
                                            <input type="text" name="name" placeholder="Name" id="name" value="" class="form-control @error('name') is-invalid @enderror rounded-pill">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6 pb-4">
                                            <input type="text" name="user_name" placeholder="User Name" id="user_name" value="" class="form-control @error('user_name') is-invalid @enderror rounded-pill">
                                            @if ($errors->has('user_name'))
                                                <span class="text-danger">{{ $errors->first('user_name') }}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 col-lg-6 pb-4">
                                            <input type="text" name="phone_number" placeholder="Phone Number" id="phone_number" value="" class="form-control @error('phone_number') is-invalid @enderror rounded-pill">
