                                ...
                                <div class="login-wrap p-0">
                                    ...
                                    <form class="ps-3 pe-3 form" method="post" action="/forgot-password" name="myForm" id="form">
                                        ...
                                        <div class="col-md-12 col-lg-12 pb-3">
                                            <input type="text" name="email" placeholder="E-mail" id="email" class="form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> rounded-pill">
                                        ...
                                        <div class="col-md-12 col-lg-12 pb-3">
                                            <input type="password" name="password" placeholder="New Password" id="my_password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-pill">
                                        ...
                                        <div class="col-md-12 col-lg-12 pb-3">
                                            <input type="password" name="confirm_password" placeholder="Confirm Password" id="confirm_password" class="form-control <?php $__errorArgs = ['confirm_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\studentmark\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>